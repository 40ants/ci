...
### [function](e9e1) `40ants-ci:generate` system &key path
...
### [function](370e) `40ants-ci/jobs/run-tests:run-tests` &rest rest &key coverage qlfile asdf-system asdf-version os quicklisp lisp exclude custom

Creates a job step of class [`run-tests`][6cb7].

<a id="x-2840ANTS-CI-2FJOBS-2FRUN-TESTS-3ARUN-TESTS-20CLASS-29"></a>

### [class](433e) `40ants-ci/jobs/run-tests:run-tests` (lisp-job)

This job test runs tests for a given `ASDF` system.

<a id="x-2840ANTS-CI-2FJOBS-2FDOCS-3ABUILD-DOCS-20FUNCTION-29"></a>

### [function](da51) `40ants-ci/jobs/docs:build-docs` &key asdf-system asdf-version (error-on-warnings t)

Creates a job of class [`build-docs`][1ddb].

<a id="x-2840ANTS-CI-2FJOBS-2FDOCS-3ABUILD-DOCS-20CLASS-29"></a>

### [class](b60a) `40ants-ci/jobs/docs:build-docs` (lisp-job)
...
### [function](8c24) `40ants-ci/jobs/linter:linter` &key asdf-systems asdf-version
...
### [class](0f34) `40ants-ci/jobs/critic:critic` (lisp-job)

<a id="x-2840ANTS-CI-2FJOBS-2FCRITIC-3ACRITIC-20FUNCTION-29"></a>

### [function](a061) `40ants-ci/jobs/critic:critic` &key asdf-systems asdf-version ignore-critiques
...
[e9e1]: https://github.com/40ants/ci/blob/d69bd51835b6dd162667de98d3babf3fb8bb4111/src/core.lisp#L523
[0f34]: https://github.com/40ants/ci/blob/d69bd51835b6dd162667de98d3babf3fb8bb4111/src/jobs/critic.lisp#L13
[a061]: https://github.com/40ants/ci/blob/d69bd51835b6dd162667de98d3babf3fb8bb4111/src/jobs/critic.lisp#L23
[b60a]: https://github.com/40ants/ci/blob/d69bd51835b6dd162667de98d3babf3fb8bb4111/src/jobs/docs.lisp#L13
[da51]: https://github.com/40ants/ci/blob/d69bd51835b6dd162667de98d3babf3fb8bb4111/src/jobs/docs.lisp#L20
[8c24]: https://github.com/40ants/ci/blob/d69bd51835b6dd162667de98d3babf3fb8bb4111/src/jobs/linter.lisp#L19
[433e]: https://github.com/40ants/ci/blob/d69bd51835b6dd162667de98d3babf3fb8bb4111/src/jobs/run-tests.lisp#L19
[370e]: https://github.com/40ants/ci/blob/d69bd51835b6dd162667de98d3babf3fb8bb4111/src/jobs/run-tests.lisp#L29
